...
function F1teszt(aH, fH) {
    try {
        ...
        document.write(`<tr><td>Random szám generáló teszt</td><td>HIBA</td><td>HIBA</td><td>HIBA</td></tr>`);
    }
}
...
function F2teszt1(M, aH, fH) {
    try {
        ...
        document.write(`<tr><td>Random tömb generáló teszt elemek száma</td><td>HIBA</td><td>HIBA</td><td>HIBA</td></tr>`);
    }
}
...
function F2teszt2(M, aH, fH) {
    try {
        ...
        document.write(`<tr><td>Random tömb generáló teszt elemek értéke</td><td>HIBA</td><td>HIBA</td><td>HIBA</td></tr>`);
    }
}
...
function F3teszt(mintaErtek, elvartErtek) {
    try {
        ...
        document.write(`<tr><td>Duplázó függvény tesztje</td><td>HIBA</td><td>HIBA</td><td>HIBA</td></tr>`);
    }
}
...
function F4teszt(mintaErtek, elvartErtek) {
    ...
    {
        document.write(`<tr><td>Prímek száma függvény tesztje</td><td>HIBA</td><td>HIBA</td><td>HIBA</td></tr>`);
    }
}
...
function F5teszt(mintaErtek, elvartErtek) {
    try {
        ...
        if (sikeresseg == true) {
            document.write(`<tr><td>Egyedi elemek függvény tesztje</td><td>${mintaErtek}</td><td>${fEredmeny}</td><td>Sikeres teszt</td></tr>`);
        }
        else {
            document.write(`<tr><td>Egyedi elemek függvény tesztje</td><td>${mintaErtek}</td><td>${fEredmeny}</td><td>Sikertelen teszt</td></tr>`);
        }
    }
    catch {
        document.write(`<tr><td>Egyedi elemek függvény tesztje</td><td>HIBA</td><td>HIBA</td><td>HIBA</td></tr>`);
    }
}
